...
use App\Models\UserLikeVideoModel;
...
class UserLikeVideoController extends Controller
{
    ...
    /**
     * @param UserLikeVideoModel $model
     * @param Request $request
     */
    public function index(UserLikeVideoModel $model, Request $request)
    {
        $count = $model->count();
    ...
    public function show(UserLikeVideoModel $model, string $id)
    {
        return $model->findOrFail($id);
    }

    public function search(UserLikeVideoModel $model, Request $request)
    {
        $this->validate($request, [
            'query' => 'required',
        ]);
    ...
    public function update(UserLikeVideoModel $model, Request $request, string $id)
    {
    ...
    public function delete(UserLikeVideoModel $model, string $id)
    {
        $query = $model->findOrFail($id);
        $query->delete();
